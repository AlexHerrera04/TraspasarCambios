...
export async function loginUser(email, password) {
  const response = await fetch("https://d2dy88a4l687h9.cloudfront.net/accounts/login", {
    method: "POST",
    headers: {
...
export async function getNewContents() {
  ...
  const response = await fetch("https://d2dy88a4l687h9.cloudfront.net/contents/new", {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
...
export async function getGoalsList({ status = null, priority = null } = {}) {
  ...
  let url = "https://d2dy88a4l687h9.cloudfront.net/goals/";
...
export async function getContentDetail(id) {
  ...
  const response = await fetch(`https://d2dy88a4l687h9.cloudfront.net/contents/${id}`, {
    method: "GET",
    headers: {
      "Content-Type": "application/json",
      Authorization: "Bearer " + token
