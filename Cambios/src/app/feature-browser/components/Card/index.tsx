...
const QuickSummaryFeatureImage = ({
  ...
  return (
    <div className="w-80 max-w-full rounded-md shadow-md shadow-dark transition-all">
      <motion.div
        className={classNames({
          'relative flex h-48 w-full flex-col items-center rounded-lg shadow-md shadow-blue-gray-500/10':
            true,
        })}
      >
        {hasImage ? (
    ...
    <div className="w-full p-4">
      <div className="my-4 flex w-full flex-col gap-8">
        <div className="flex w-full flex-col items-start gap-6 md:flex-row md:items-center">
          ...
          <div className="flex w-full flex-col items-start justify-center gap-3 md:min-h-[12rem]">
        ...
        <div className="w-full">
          <Typography variant="h6">Aspectos destacados</Typography>
        ...
        <div className="flex w-full justify-end">
          <Button primary onClick={onOpenDetails}>
            Ver detalles
          </Button>
        </div>
      </div>
...
export const Card = (props: Props) => {
  ...
  const handleGoToDetails = React.useCallback(() => {
    ...
    handleOpenDetails();
  }, [handleCloseQuickSummary, handleOpenDetails]);
